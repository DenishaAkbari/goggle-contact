...
import { loginAsncy, loginGoogle } from '../../Service/Action/loginAction';
    ...
    <div className='login-form'>
      <Container>
        ...
        <form className='p-5 bg-light rounded-4' onSubmit={handleConSubmit}>
          ...
          <button type='submit' className="btn btn-primary" onClick={handleGoogle} style={{marginLeft: '745px' ,marginTop: '-170px'}}>GOOGLE</button>
      </Container>
    </div>
    </>
  )
